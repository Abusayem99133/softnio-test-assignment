...
const Footer = () => {
  return (
    <div>
      <footer
        className="footer footer-center   p-10 text-white"
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(${imageF})`,
      ...
      >
        <aside>
          ...
          <div className="flex justify-between gap-4">
            <div>
              <span className="text-2xl mx-auto flex justify-center mb-4">
